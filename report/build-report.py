...
links = [[P("Repositorio público", "Small"), P("https://github.com/ZaqueoChivalan/-S9-Contrato-consumidor-proveedor-con-Pact", "Small")], [P("GitHub Actions", "Small"), P("https://github.com/ZaqueoChivalan/-S9-Contrato-consumidor-proveedor-con-Pact/actions", "Small")], [P("Video <= 3 minutos", "Small"), P("https://REEMPLAZAR_ENLACE_DEL_VIDEO", "Small")]]
...
story += [lt, Spacer(1, 8*mm), P("Nota: sustituye el marcador del video por el enlace real antes de subir el PDF final.", "Small")]
